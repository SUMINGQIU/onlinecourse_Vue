<template>
  <div class="about">
    <h2 class="justified-text">这是一个在线学习平台，我们提供国外大学著名CS公开课的中文翻译，一起学习。</h2>
  ...
  <!-- 由于UP还是学生，服务器租用费都是自掏腰包，
    所以解锁一节课的全部人工翻译需要购买，当然机翻字幕和视频都是免费的，每门课程的前1/3的课都有我们提供的人工翻译，
    未解锁的观众在之后的2/3也可以看到机翻和简单错误筛选后的课程。 -->
</template>
